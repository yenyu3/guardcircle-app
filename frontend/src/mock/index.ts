...
export const mockKnowledgeCards: KnowledgeCard[] = [
  ...
  },
  {
    ...
    exampleScript:
      "「我有內部消息，這支股票下週必漲，先投個5萬試試，上週我朋友賺了3倍，你要不要一起？」",
  ...
  },
  {
    ...
    exampleScript:
      "「我是刑事局偵查員，你的帳戶被用於洗錢，為配合調查需將存款轉至指定帳戶保管，事後會歸還。」",
  ...
  },
  {
    ...
    exampleScript:
      "「全新iPhone 15 Pro只要3000，因為急需用錢，要的話私訊我，用轉帳比較快。」",
    howToRespond:
      "使用有保障的購物平台，避免私下轉帳交易，價格異常低廉要特別警覺。",
  },
];
