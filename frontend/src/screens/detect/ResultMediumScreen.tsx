    ...
    <View style={styles.root}>
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.actions}>
          <TouchableOpacity style={styles.primaryBtn} onPress={() => Alert.alert('已通知家人', '家人會盡快回覆你')} activeOpacity={0.85}>
            <Text style={[styles.primaryBtnText, { color: BG }]}>聯絡家人確認</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.outlineBtn} onPress={() => Alert.alert('撥打 165')} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  safe: { flex: 1, justifyContent: 'space-between', paddingHorizontal: 32, paddingVertical: 24 },
  ...
  title: { fontSize: 40, fontWeight: '900', color: '#fff', textAlign: 'center', letterSpacing: -1, lineHeight: 50 },
  ...
  factorText: { fontSize: 16, fontWeight: '600', color: '#fff', opacity: 0.9, flex: 1 },
  actions: { gap: 14, paddingBottom: 8 },
  primaryBtn: {
    backgroundColor: CREAM, borderRadius: 999, paddingVertical: 22, alignItems: 'center',
    shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, elevation: 4,
  },
  primaryBtnText: { fontSize: 22, fontWeight: '900' },
  outlineBtn: { borderWidth: 2, borderColor: '#fff', borderRadius: 999, paddingVertical: 20, alignItems: 'center' },
