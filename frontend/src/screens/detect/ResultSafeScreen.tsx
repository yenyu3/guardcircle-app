    ...
    <View style={styles.root}>
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.actions}>
          <TouchableOpacity style={styles.primaryBtn} onPress={() => navigation.navigate('Main')} activeOpacity={0.85}>
            <Text style={[styles.primaryBtnText, { color: BG }]}>返回首頁</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.outlineBtn} onPress={() => Alert.alert('已通知家人', '家人會盡快回覆你')} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  desc: { fontSize: 20, fontWeight: '600', color: '#fff', textAlign: 'center', lineHeight: 30, opacity: 0.95 },
