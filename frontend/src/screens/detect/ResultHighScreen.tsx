    ...
    <View style={styles.root}>
      <SafeAreaView style={styles.safe}>
        <View style={styles.content}>
          ...
          <Text style={styles.desc}>這個訊息要求你轉帳，很可能是詐騙</Text>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            <Text style={styles.primaryBtnText}>請勿轉帳</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            <Text style={styles.outlineBtnText}>已通知家人</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </View>
